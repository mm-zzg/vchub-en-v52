...
| LReal                    | This data type is displayed when the data type of the tag is Double.<br>  **Note**: Due to Siemens device limitations, this data type is only supported on the following models:   <br>- S7-1200  <br>- S7-1500 | 
